...
void TestVtkmTable()
{
  ...
  // vtkmTable.Select(selectedArgument);
  // vtkmTable.Select("X", "QuantizeByBin", "2" );
  // vtkmTable.Select("Y", "QuantizeByMinDelta", "0", "1.5" );
  // vtkmTable.Select("V", "" );
  vtkmTable.Select("X" );
  vtkmTable.Select("Y" );
  vtkmTable.Select("X", "ADD", "Y" );
...
int UnitTestVtkmTable(int, char* [])
{ 

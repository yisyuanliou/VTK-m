...
void TestFieldEntropy()
{
  ...
  vtkm::worklet::FieldEntropy entropy;
  //entropy.Run(p_poisson, p_normal, numberOfBins, VTKM_DEFAULT_DEVICE_ADAPTER_TAG());
  std::vector<vtkm::cont::ArrayHandle<vtkm::Float32>> arrayHandles;
  arrayHandles.push_back(p_poisson);
  arrayHandles.push_back(p_normal);
  std::cout << entropy.Run(arrayHandles, numberOfBins, VTKM_DEFAULT_DEVICE_ADAPTER_TAG()) << std::endl;
  // Run data
...
int UnitTestFieldEntropy(int, char* [])
{
  return vtkm::cont::testing::Testing::Run(TestFieldEntropy);
}
